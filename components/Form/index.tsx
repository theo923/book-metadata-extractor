...
import TagManager from "../Tag_Manager/index";
...
const Form = (props: FormProps): JSX.Element => {
    ...
    const [structuredData, setStructureData] = useState<object>({});
    ...
    }, [props.tagData, description, props.url]);
            ...
            <Box flex flexDirection="column">
                ...
                >
                    ...
                    <Button
                        onClick={() => {
                            setSelector("Hdou");
                            setTextFormat(Hdoujin(info, structuredData));
                        }}
                    >
                        HDJ
                    </Button>
